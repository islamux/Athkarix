class AthkarSabahText {
  static const String athkarSabah1 = """
الْحَمْدُ لِلَّهِ وَحْدَهُ، وَالصَّلاَةُ وَالسَّلاَمُ عَلَى مَنْ لاَ نَبِيَّ بَعْدَهُ 
""";
  static const String athkarSabah1_Footer = """
---------------------
...
""";
  ...
  static const String athkarSabah111 = """
...
""";
  static const String athkarSabah111_Footer = """
---------------------
...
""";
  ...
  static const String athkarSabah11 = """
...
بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ {قُلْ أَعُوذُ بِرَبِّ النَّاسِ* مَلِكِ النَّاسِ* إِلَهِ النَّاسِ* مِن شَرِّ الْوَسْوَاسِ الْخَنَّاسِ* الَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاسِ* مِنَ الْجِنَّةِ وَالنَّاسِ}
 ثلاثَ مرَّاتٍ
""";
  static const String athkarSabah11_Footer = """
---------------------
 من قالها ثلاث مرات حين يصبح وحين يمسي كفته من كل شيء. أخرجه أبو داود، ٤/ ٣٢٢، برقم ٥٠٨٢، والترمذي، ٥/ ٥٦٧، برقم ٣٥٧٥، وانظر: صحيح الترمذي، ٣/ ١٨٢
  ...
  """;
  static const String athkarSabah222 = """
...
""";
  static const String athkarSabah222_Footer = """
---------------------
وإذا أمسى قال: أمسينا وأمسى الملك للَّه

""";

  static const String athkarSabah2 = """
اللَّهُمَّ بِكَ أَصْبَحْنَا، وَبِكَ أَمْسَيْنَا ، وَبِكَ نَحْيَا، وَبِكَ نَمُوتُ وَإِلَيْكَ النُّشُورُ
""";
  static const String athkarSabah2_Footer = """
---------------------
...
""";
  ...
  static const String athkarSabah22 = """
...
""";
  static const String athkarSabah22_Footer = """
---------------------
 أقر وأعترف *
 من قالها موقناً بها حين يمسي، فمات من ليلته دخل الجنة، وكذلك إذا أصبح. أخرجه البخاري، ٧/ ١٥٠، برقم ٦٣٠٦
  ...
  static const String athkarSabah3 = """
اللَّهُمَّ إِنِّي أَصْبَحْتُ  أُشْهِدُكَ، وَأُشْهِدُ حَمَلَةَ عَرْشِكَ، وَمَلاَئِكَتِكَ، وَجَمِيعَ خَلْقِكَ، أَنَّكَ أَنْتَ اللَّهُ لَا إِلَهَ إِلاَّ أَنْتَ وَحْدَكَ لاَ شَرِيكَ لَكَ، وَأَنَّ مُحَمَّداً عَبْدُكَ وَرَسُولُكَ 
  ...
  """;
  static const String athkarSabah3_Footer = """
---------------------
...
""";
  ...
  static const String athkarSabah4 = """
...
""";
  static const String athkarSabah4_Footer = """
---------------------
...
""";
  ...
  static const String athkarSabah44 = """
اللَّهُمَّ عَافِنِي فِي بَدَنِي، اللَّهُمَّ عَافِنِي فِي سَمْعِي، اللَّهُمَّ عَافِنِي فِي بَصَرِي، لاَ إِلَهَ إِلاَّ أَنْتَ
 ...
 اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْكُفْرِ، وَالفَقْرِ، وَأَعُوذُ بِكَ مِنْ عَذَابِ القَبْرِ، لاَ إِلَهَ إِلاَّ أَنْتَ
  (ثلاثَ مرَّاتٍ)
""";
  static const String athkarSabah44_Footer = """
---------------------
...
٤/ ٣١٨، برقم ١٥٣١، والترمذي، ٥/ ٤٦٥، برقم، ٣٣٨٩، وحسّنه ابن باز - رحمه الله - في تحفة الأخيار ص٣٩.
  ...
  static const String athkarSabah8 = """
يَا حَيُّ يَا قَيُّومُ بِرَحْمَتِكَ أَسْتَغيثُ أَصْلِحْ لِي شَأْنِيَ كُلَّهُ وَلاَ تَكِلْنِي إِلَى نَفْسِي طَرْفَةَ عَيْنٍ
""";
  static const String athkarSabah8_Footer = """
---------------------
 الحاكم وصححه، ووافقه الذهبي، ١/ ٥٤٥، وانظر: صحيح الترغيب والترهيب، ١/ ٢٧٣

  """;
  static const String athkarSabah9 =
...
""";
  static const String athkarSabah9_Footer = """
---------------------
...
وإذا أمسى قال: اللَّهم إني أسألك خير هذه الليلة: فتحها، ونصرها، ونورها، وبركتها، وهداها، وأعوذ بك من شر ما فيها، وشر ما بعدها
  ...
  static const String athkarSabah10 = """
...
""";
  static const String athkarSabah10_ = """
---------------------
...
سُبْحَانَ اللَّهِ وَبِحَمْدِهِ *
  (مائة مرَّةٍ)
""";
  static const String athkarSabah1111_Footer = """
---------------------
في مسند احمد *
...
من قالها مائة مرة حين يصبح وحين يمسي لم يأت أحد يوم القيامة بأفضل مما جاء به إلا أحد قال مثل ما قال أو زاد عليه. مسلم، ٤/ ٢٠٧١ برقم ٢٦٩٢
 ...
 """;
  static const String athkarSabah12 = """
لاَ إِلَهَ إِلاَّ اللَّهُ وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ
  (عشرَ مرَّات ، أَوْ مرَّةً واحدةً عندَ الكَسَلِ)
""";
  static const String athkarSabah12_Footer = """
---------------------
 أبو داود، برقم ٥٠٧٧، وابن ماجه، برقم ٣٧٩٨، وأحمد، برقم ٨٧١٩، وانظر: صحيح الترغيب والترهيب، ١/ ٢٧٠، وصحيح أبي داود، ٣/ ٩٥٧، وصحيح ابن ماجه، ٢/ ٣٣١، وزاد المعاد، ٢/ ٣٧٧
  ...
  """;
  static const String athkarSabah13 = """
لاَ إِلَهَ إِلاَّ اللَّهُ، وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ
   (مائةَ مرَّةٍ إذا أصبحَ)
""";
  static const String athkarSabah13_Footer = """
---------------------
 ...
 """;
  static const String athkarSabah14 = """
سُبْحَانَ اللَّهِ وَبِحَمْدِهِ عَدَدَ خَلْقِهِ، وَرِضَا نَفْسِهِ، وَزِنَةَ عَرْشِهِ، وَمِدَادَ كَلِمَاتِهِ
  ثلاثَ مرَّاتٍ إذا أصبحَ
""";
  static const String athkarSabah14_Footer = """
---------------------
 مسلم، ٤/ ٢٠٩٠، برقم ٢٧٢٦

 """;
  static const String athkarSabah15 = """
اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْماً نَافِعاً، وَرِزْقاً طَيِّباً، وَعَمَلاً مُتَقَبَّلاً
  (إذا أصبحَ)
""";
  static const String athkarSabah15_Footer = """
---------------------
 ...
 """;
  ...
  static const String athkarSabah16 = """
أَسْتَغْفِرُ اللَّهَ وَأَتُوبُ إِلَيْهِ
   (مِائَةَ مَرَّةٍ فِي الْيَوْمِ)
""";
  static const String athkarSabah16_Footer = """
---------------------
 البخاري مع الفتح، ١١/ ١٠١، برقم ٦٣٠٧، ومسلم، / ٢٠٧٥، برقم ٢٧٠٢

""";
  static const String athkarSabah18 = """
اللَّهُمَّ صَلِّ وَسَلِّمْ عَلَى نَبَيِّنَا مُحَمَّدٍ
   (عشرَ مرَّاتٍ) 
""";
  static const String athkarSabah18_Footer = """
---------------------
