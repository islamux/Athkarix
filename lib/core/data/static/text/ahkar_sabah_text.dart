...
""";
  static const String athkarSabah1Footer = """
---------------------
...
""";
  static const String athkarSabah111Footer = """
---------------------
...
بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ {قُلْ أَعُوذُ بِرَبِّ النَّاسِ* مَلِكِ النَّاسِ* إِلَهِ النَّاسِ* مِن شَرِّ الْوَسْوَاسِ الْخَنَّاسِ* الَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاسِ* مِنَ الْجِنَّةِ وَالنَّاسِ}
 ثلاثَ مرَّاتٍ
""";
  static const String athkarSabah11Footer = """
---------------------
...
""";
  static const String athkarSabah222Footer = """
---------------------
...
""";
  static const String athkarSabah2Footer = """
---------------------
...
""";
  static const String athkarSabah22Footer = """
---------------------
 أقر وأعترف *
...
اللَّهُمَّ إِنِّي أَصْبَحْتُ  أُشْهِدُكَ، وَأُشْهِدُ حَمَلَةَ عَرْشِكَ، وَمَلاَئِكَتِكَ، وَجَمِيعَ خَلْقِكَ، أَنَّكَ أَنْتَ اللَّهُ لَا إِلَهَ إِلاَّ أَنْتَ وَحْدَكَ لاَ شَرِيكَ لَكَ، وَأَنَّ مُحَمَّداً عَبْدُكَ وَرَسُولُكَ 
  ...
  """;
  static const String athkarSabah3Footer = """
---------------------
...
""";
  static const String athkarSabah4Footer = """
---------------------
...
اللَّهُمَّ عَافِنِي فِي بَدَنِي، اللَّهُمَّ عَافِنِي فِي سَمْعِي، اللَّهُمَّ عَافِنِي فِي بَصَرِي، لاَ إِلَهَ إِلاَّ أَنْتَ
 ...
 اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْكُفْرِ، وَالفَقْرِ، وَأَعُوذُ بِكَ مِنْ عَذَابِ القَبْرِ، لاَ إِلَهَ إِلاَّ أَنْتَ
  (ثلاثَ مرَّاتٍ)
""";
  static const String athkarSabah44Footer = """
---------------------
...
حَسْبِيَ اللَّهُ لاَ إِلَهَ إِلاَّ هُوَ عَلَيهِ تَوَكَّلتُ وَهُوَ رَبُّ الْعَرْشِ الْعَظِيمِ
  (سَبْعَ مَرّات)
""";
  static const String athkarSabah5Footer = """
---------------------
...
""";
  static const String athkarSabah55Footer = """
---------------------
...
""";
  static const String athkarSabah6Footer = """
---------------------
...
بِسْمِ اللَّهِ الَّذِي لاَ يَضُرُّ مَعَ اسْمِهِ شَيْءٌ فِي الْأَرْضِ وَلاَ فِي السّمَاءِ وَهُوَ السَّمِيعُ الْعَلِيمُ
  (ثلاثَ مرَّات)
""";
  static const String athkarSabah66Footer = """
---------------------
...
رَضِيتُ بِاللَّهِ رَبَّاً، وَبِالْإِسْلاَمِ دِيناً، وَبِمُحَمَّدٍ - صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ - نَبِيّاً
  (ثلاثَ مرَّات)
""";
  static const String athkarSabah7Footer = """
---------------------
...
""";
  static const String athkarSabah8Footer = """
---------------------
...
""";
  static const String athkarSabah9Footer = """
---------------------
...
""";
  static const String athkarSabah12Footer = """
---------------------
...
""";
  static const String athkarSabah13Footer = """
---------------------
...
""";
  static const String athkarSabah14Footer = """
---------------------
...
اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْماً نَافِعاً، وَرِزْقاً طَيِّباً، وَعَمَلاً مُتَقَبَّلاً
  (إذا أصبحَ)
""";
  static const String athkarSabah15Footer = """
---------------------
...
""";
  static const String athkarSabah16Footer = """
---------------------
...
اللَّهُمَّ صَلِّ وَسَلِّمْ عَلَى نَبَيِّنَا مُحَمَّدٍ
   (عشرَ مرَّاتٍ) 
""";
  static const String athkarSabah18Footer = """
---------------------
