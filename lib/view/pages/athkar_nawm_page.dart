...
import 'package:athkarix/view/widget/custom_text_slider_athkar_nawm.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class AthkarNawm extends StatelessWidget {
  const AthkarNawm({super.key});

  @override
  Widget build(BuildContext context) {
    final controllerN = Get.find<AthkarNawmControllerImp>();
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: () => customShareContent(controllerN),
        ...
        leading: GestureDetector(
          onTap: () {
            ...
            Get.find<AthkarNawmControllerImp>().resetCounter();
      ...
      body: SafeArea(
        child: GestureDetector(
            onTap: () {
              ...
              controllerN.increamentPageController();
            },
            child: const CustomTextSliderAthkarNawm()),
      ),
      ...
      floatingActionButton: Row(
        ...
        children: [
          GetBuilder<FloatingButtonControllerImp>(
            builder: (context) {
              return GetBuilder<AthkarNawmControllerImp>(builder: (context) {
                return CustomFloatingButton(
                  herotag: 'f2',
                  onPressed: () => controllerN.increamentPageController(),
                  text: Text(
                    '${controllerN.currentPageCounter}',
