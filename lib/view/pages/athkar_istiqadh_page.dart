...
import 'package:athkarix/view/widget/custom_text_slider_athkar_istiqadh.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class AthkarIstiqadh extends StatelessWidget {
  const AthkarIstiqadh({super.key});

  @override
  Widget build(BuildContext context) {
    final controllerI = Get.find<AthkarIstiqadhControllerImp>();
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: () => customShareContent(controllerI),
        ...
        leading: GestureDetector(
          onTap: () {
            ...
            Get.find<AthkarIstiqadhControllerImp>().resetCounter();
      ...
      body: SafeArea(
        child: GestureDetector(
            onTap: () {
              ...
              controllerI.increamentPageController();
            },
            child: const CustomTextSliderAthkarIstiqadh()),
      ),
      ...
      floatingActionButton: Row(
        ...
        children: [
          GetBuilder<FloatingButtonControllerImp>(
            builder: (context) {
              return GetBuilder<AthkarIstiqadhControllerImp>(builder: (context) {
                return CustomFloatingButton(
                  herotag: 'f2',
                  onPressed: () => controllerI.increamentPageController(),
                  text: Text(
                    '${controllerI.currentPageCounter}',
