...
class CustomTextSliderAthkarIstiqadh extends StatelessWidget {
  const CustomTextSliderAthkarIstiqadh({super.key});
    ...
    return Stack(
      children: [
        ...
        SizedBox(
          ...
          child: GetBuilder<AthkarIstiqadhControllerImp>(
            builder: (controller) {
